    ...
    public function get_attributes($default = false){
        $attributes = array(
            ...
            'tickLabelSpace' => [
                ...
                'style' => [
                    (object)[
                        'selector'=>'{{ULTP}} .ultp-news-ticker-box { padding-left:{{tickLabelSpace}}px; }'
                    ],
                ],
            ],
            'tickShapeStyle' => [
            ...
            'tickImgSpace' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-news-ticker li div img {margin-right: {{tickImgSpace}}px}'
                    ],
                ],
            ],
            'tickImgRadius' => [
            ...
            'tickerPosition' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-news-sticky .ultp-newsTicker-wrap { position: fixed;width: 100%;top: 0;z-index: 9999999; left: 0; }'
                    ],
                    (object)[
                        'depends' => [
                            (object)['key'=>'tickerPositionEna','condition'=>'==','value'=> true],
                    ...
                    $wraper_before .= '<div class="ultp-block-items-wrap">';
                        ...
                        $post_loop .= '<div class="ultp-news-ticker-'.$attr['TickNavStyle'].' ultp-nav-'.$attr['TickNavIconStyle'].'  ultp-newsTicker-wrap ultp-newstick-'.$attr['tickerType'].' ">';
                            ...
                            $post_loop .= '<div class="ultp-news-ticker-box ultp-animation-'.($attr['tickerType'] == 'typewriter' ? $attr['typeAnimation'] : $attr['tickerAnimation'] ).' ultp-sliderDir-'.($attr['tickerType'] == 'vertical' ? $attr['tickerDirectionVer'] : $attr['tickerDirectionHorizon'] ).'">';
                                $speed = $attr['tickerType'] != 'marquee' ? $attr['tickerSpeed'] : '';
                            ...
                            if ($attr['navControlToggle'] &&  $attr['TickNavStyle']  ) {
                                $post_loop .= '<div class="ultp-news-ticker-controls ultp-news-ticker-vertical-controls">';
                                        $post_loop .= '<button class="ultp-news-ticker-arrow ultp-news-ticker-prev prev">'.$arrowLeft.'</button>';
                                        if ($attr['controlToggle'] && ( $attr['TickNavStyle']  == "nav1" ||  $attr['TickNavStyle']  == "nav3" ||  $attr['TickNavStyle']  == "nav4" )) {
                                            $post_loop .= '<button id="ultp-pause-btn" class="ultp-news-ticker-pause pause"></button>';
                                        }
                                        $post_loop .= '<button class="ultp-news-ticker-arrow ultp-news-ticker-next next">'.$arrowRight.'</button>';
                                $post_loop .= '</div>';
                            }
                        $post_loop .= '</div>';
                    $wraper_after .= '</div>';

...
<section class="text-center">
    <h1 class="container titulo my-5">
        ¿Te gustaría asesorar a tus clientes para participar
        en la próxima generación de UNICORNIOS* mexicanos?
    </h1>
    <h4 class="subtitulo mb-5 container">
        Te compartiremos cómo lo hacemos y las condiciones para formar parte de este exclusivo grupo de asesores en estrategia de inversión. 
    </h4>
    <h4 class="titulo">
        Únete como asesor finaciero
    </h4>
    <div class="row mx-0 my-5">
        <div class="col-md-6 text-left p-left">
        <?php
        $req = "required";
        $source = "asesores";
        ...
        <div class=" col-md-6 text-right">
            <img src="<?php echo get_bloginfo("stylesheet_directory") ?>/assets/images/eventoasesores.png">
        </div>
    </div>

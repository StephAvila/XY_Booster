...
<section class="text-center">
    <h1 class="text-center my-5 titulo">
        Inscríbete a nuestro evento: <br><br> <?php echo @$_GET['event']; ?> <br><br> el <?php echo @$_GET['date'];?>
    </h1>
...
<section class="py-3" style="background-color: #F5F5F5">
    <div class="row words">
        ...
        <div class="col-md-8 pl-sm-5 d-flex flex-column justify-content-center align-items-center">
            ...
            <a href="<?php echo get_bloginfo("url") ?>/agendar-cita/?origen=Participa&proyecto=General" class="button2 px-sm-5">Agendar</a>
        </div>

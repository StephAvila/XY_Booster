<form method="post" id="form-contact">
    ...
    <label class="col-md-12 px-4 font-weight-bold h6" style="<?php echo $class2?>">Ciudad<br>
        <input class="w-100 my-md-2" type="text" name="country" id="country" value="" size="40" required>
    </label><br>

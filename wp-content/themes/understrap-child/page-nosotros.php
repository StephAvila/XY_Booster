...
<section class="row" id="manifiesto">
    <div class="col-lg-6 d-flex flex-column justify-content-center p-left">
        ...
        <p class="text-justify mt-md-4 pl-lg-5 px-5"> Las empresas de servicios financieros más exitosas del futuro serán obsesivamente digitales y centradas en el Cliente.
...
<section class="container my-md-5">
    <div class="row mx-0">
        ...
        <div class="col-md-6 px-0">
            <p class="pl-3 py-sm-5 h4 titulo font-weight-bold">Tendencias en las soluciones financieras globales:</p>
    ...
    <div class="row mx-0">
        ...
        <div class="col-md-8">
            <div>
                ...
                <p class="pl-sm-5 ml-sm-3 col-md-9 my-md-2">Las soluciones financieras digitales más vanguardistas ofreciendo las máximas garantías de la regulación mexicana.</p>
            </div>
            ...
            <div class="d-flex flex-column align-items-end text-right">
                ...
                <p class="pr-sm-5 mr-sm-5 col-md-9 my-md-2">Con emprendedores y visionarios como tú, para detonar la próxima generación de Unicorns mexicanos y globales.</p>
            </div>
            <hr class="container my-sm-2">

            <h1 class="titulo pr-sm-5" data-aos="fade-left"><span class="display-1 font-weight-bold"> 3</span> Inspiramos y Divulgamos</h1>
            <p class="pl-sm-5 ml-sm-3 col-md-10 my-md-2">El conocimiento para fortalecer el ecosistema y desarrollar oportunidades de colaboración sin precedentes.</p>
        </div>
    </div>
</section>
...
<section class="my-sm-5 my-4" style="background-color: #F5F5F5">
    <div class="text-center py-5">
        ...
        <a href="<?php echo get_bloginfo("url") ?>/eventos" class="button px-sm-5">Eventos Privados</a>
    </div>
...
<section class="py-sm-5" id="neurodiversidad">
    ...
    <div class="d-flex justify-content-center">
        <p class="text-justify col-md-8 mt-md-4"> Ser un <strong>“XY Booster”</strong> implica tener una combinación de cromosomas XY alterado.
            ...
            Vivimos bajo la religión de Peter Diamandis y sus principios Peter's Laws
        </p>
    </div>
    ...
    <div class="cards-people">
        ...
        <div>
            ...
            <p class="font-italic mb-sm-4">Social Media & TikToker</p>
            <p>+15 años</p>
        </div>

        <div>
            <h1 class="titulo" data-aos="fade-up">Rodrigo</h1>
            <p class="font-italic mb-sm-4">Chief of Staff & Druida</p>
            <p class="text-justify">
                +25 años estructurando y operando estrategias de inversión bursátil, patrimonial y privada. Creó y dirigió áreas de estadística y promoción en Afore Inbursa y Cetesdirecto.
            </p>
        </div>
        <div>

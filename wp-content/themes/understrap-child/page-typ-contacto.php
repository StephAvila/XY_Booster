...
<section>
    <h1 class="titulo text-center mt-3" data-aos="zoom-in" data-aos-duration="2000">Gracias por impulsar el desarrollo <br>financiero en México</h1>
    <div class="row my-5">
        <div class="col-md-6 px-md-5 d-flex flex-column justify-content-center">
            <h1 class="titulo font-weight-bold" data-aos="fade-down-right">Bienvenido a XY Booster</h1>
        ...
        <div class="col-md-6 text-right">
            <img src="<?php echo get_bloginfo("stylesheet_directory") ?>/assets/images/01.png">
        </div>
    </div>
